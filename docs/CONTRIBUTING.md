...
<p align="justify">
To contribute, you must follow our <!-- ProjectDependant --> <a href="https://github.com/GaryNLOL/Graphite-Logger/blob/main/docs/CODE_OF_CONDUCT.md">Code of Conduct</a><!-- /ProjectDependant -->.
...
<!-- ProjectDependant -->
Contributions in Graphite-Logger should relate to:
- Logging.
<!-- /ProjectDependant -->
